...
export const Banner: FC = () => (
  <AbsoluteFill style={{ background: claude.frame }}>
    ...
    >
      {/* The left column sits ABOVE the product shot: a long install command
          overlaps the window instead of vanishing underneath it. The pill has
          a solid panel background, so the overlap reads as depth, not clutter. */}
      <div
        style={{
          width: LEFT_W,
          display: "flex",
