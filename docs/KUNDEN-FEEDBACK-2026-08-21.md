...
| --- | ------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | "Telefon vom Felix auf Web Seite anzeigen"                                      | Die sportliche Leitung auf `/fussball/herren` war eine reine Namensliste im Code, ohne Kontakt.                                                                                                                         | Namen werden gegen die Personen-Collection aufgelöst und bekommen einen Telefon- und einen E-Mail-Button. Der E-Mail-Button sieht aus wie auf `/verein/vorstand`; Telefonnummern zeigt die Vorstand-Seite auf Vereinswunsch bewusst nicht, die Fußballseiten zeigen sie. Berücksichtigt werden nur Personen mit einer Leitungsfunktion. Gepflegt wird unter **Personen**. Felix' Nummer und Adresse stehen dort bereits, es erscheint also ohne weiteres Zutun. Gilt auch für `/fussball/junioren`. |
...
| 8   | Telefonnummern                          | Veröffentlicht wird vorerst nur die Nummer von Felix Kirmeyer, weil genau die angefragt war. Die übrigen Ansprechpartner bekommen nur einen E-Mail-Button. Wer zusätzlich mit Telefonnummer erscheinen soll, bitte namentlich nennen; eine private Handynummer stellen wir nicht ungefragt online. |
