...
const SPORTS: Sport[] = [
  ...
  },
  {
    ...
    body: "Zweimal pro Woche in der Waldmeisterschule. Kraft, Mobilität und Gemeinschaft, über drei Generationen weitergegeben.",
    pills: ["2× pro Woche", "Frauen & Männer", "abends"],
    count: "1967",
    sub: "seit",
    theme: "gymnastik",
  },
