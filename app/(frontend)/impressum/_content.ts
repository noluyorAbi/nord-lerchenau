...
import type { ClubAddress } from "@/lib/club-address";

export function impressumSections(address: ClubAddress): LegalSection[] {
  return [
    {
      id: "anbieter",
      num: "01",
      ...
      blocks: [
        {
          ...
          rows: [
            ...
            { k: "Straße", v: address.street },
            { k: "PLZ / Ort", v: address.cityLine },
