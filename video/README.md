...
## SV Nord: Admin-Tutorial (dieses Projekt)
...
angepasst; `src/content.ts` und die vier Launch-Assets darunter sind vom
Launch-Template und werden hier nicht benutzt.
